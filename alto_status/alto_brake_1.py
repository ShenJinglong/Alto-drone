...
class alto_brake_1_fsm(base_fsm):
...
alto_brake_1_counter = 0
delay_counter = 0

def alto_brake_1(flight):
    global alto_brake_1_counter
    ...
    if alto_brake_1_counter == 10:
        alto_brake_1_counter = 0
        delay_counter = 0
        flight.next_state = macro.ALTO_TURN_2
        print(' >>> [!]  ALTO_BREAK_1 -> ALTO_TURN_2')