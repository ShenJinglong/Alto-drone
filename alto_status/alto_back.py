...
def alto_back(flight):
    global alto_back_counter
    ...
    if alto_back_counter == alto_params.ALTO_BACK_NUM:
        alto_back_counter = 0
        flight.next_state = macro.ALTO_DETECT_END_POLE
        print('>>> [!] ALTO_BACK -> ALTO_DETECT_END_POLE')
